...
/* ===== Plan "Regular el peso" (déficit calórico) ===== */
const WEIGHT_WEEKS=[
{Lunes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pechuga de pollo con arroz, brócoli y AOVE',cena:'Tortilla de huevos con ensalada y patata cocida'},Martes:{desayuno:'Huevos revueltos con tostadas integrales y naranja',comida:'Merluza al horno con patata y calabacín',cena:'Pechuga de pavo con ensalada y arroz'},Miércoles:{desayuno:'Yogur con avena, fresas y canela',comida:'Ternera magra con patata asada y verduras',cena:'Salmón con brócoli y ensalada'},Jueves:{desayuno:'Tostadas integrales con pavo, tomate y kiwi',comida:'Pollo con arroz, pimientos y calabacín',cena:'Tortilla de verduras con ensalada'},Viernes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pasta integral con pollo, tomate y verduras',cena:'Merluza con patata y ensalada'},Sábado:{desayuno:'Huevos con tostadas integrales y fruta',comida:'Ternera magra con arroz y verduras',cena:'Pollo a la plancha con ensalada y patata'},Domingo:{desayuno:'Yogur con avena y fruta',comida:'Pollo al horno con patata y ensalada',cena:'Tortilla de verduras con ensalada'}},
{Lunes:{desayuno:'Avena con yogur, plátano y canela',comida:'Pechuga de pollo con arroz, brócoli y AOVE',cena:'Merluza con patata y ensalada'},Martes:{desayuno:'Huevos revueltos con tostadas integrales y kiwi',comida:'Ternera magra con patata y ensalada',cena:'Pavo con ensalada y patata'},Miércoles:{desayuno:'Yogur con avena y frutos rojos',comida:'Salmón con patata y brócoli',cena:'Tortilla de huevos con ensalada y patata cocida'},Jueves:{desayuno:'Tostadas integrales con pavo, tomate y fruta',comida:'Pasta integral con pollo y verduras',cena:'Tortilla de verduras con ensalada'},Viernes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pavo con arroz y verduras',cena:'Salmón con verduras y patata'},Sábado:{desayuno:'Huevos con tostadas integrales y fruta',comida:'Ternera magra con patata y ensalada',cena:'Pollo con verduras y arroz'},Domingo:{desayuno:'Yogur con avena y fruta',comida:'Lentejas con verduras y pollo',cena:'Tortilla de huevos con ensalada y patata cocida'}},
{Lunes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pollo con arroz y verduras',cena:'Merluza con patata y ensalada'},Martes:{desayuno:'Huevos revueltos con tostadas integrales y naranja',comida:'Ternera magra con patata y brócoli',cena:'Pavo con arroz y verduras'},Miércoles:{desayuno:'Yogur con avena, kiwi y canela',comida:'Salmón con arroz y verduras',cena:'Tortilla de verduras con ensalada'},Jueves:{desayuno:'Tostadas integrales con pavo, tomate y fruta',comida:'Pollo con patata y ensalada',cena:'Merluza con verduras y patata'},Viernes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pasta integral con ternera y verduras',cena:'Pollo con ensalada y arroz'},Sábado:{desayuno:'Huevos con tostadas integrales y fruta',comida:'Pavo con arroz y verduras',cena:'Salmón con ensalada y patata'},Domingo:{desayuno:'Yogur con avena y frutos rojos',comida:'Pollo al horno con patata y verduras',cena:'Tortilla de verduras con ensalada'}},
{Lunes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pechuga de pollo con arroz, brócoli y AOVE',cena:'Merluza con patata y ensalada'},Martes:{desayuno:'Huevos revueltos con tostadas integrales y kiwi',comida:'Ternera magra con patata y ensalada',cena:'Pavo con ensalada y patata'},Miércoles:{desayuno:'Yogur con avena y frutos rojos',comida:'Salmón con patata y verduras',cena:'Tortilla de verduras con ensalada'},Jueves:{desayuno:'Tostadas integrales con pavo, tomate y fruta',comida:'Pasta integral con pollo y verduras',cena:'Merluza con patata y ensalada'},Viernes:{desayuno:'Yogur proteico con avena y plátano',comida:'Pavo con arroz y verduras',cena:'Salmón con verduras y patata'},Sábado:{desayuno:'Huevos con tostadas integrales y fruta',comida:'Ternera magra con patata y ensalada',cena:'Pollo con verduras y arroz'},Domingo:{desayuno:'Yogur con avena y fruta',comida:'Pollo al horno con patata y ensalada',cena:'Tortilla de verduras con ensalada'}}
];
const MASS_WEEKS=[
{Lunes:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con pavo',comida:'Arroz con pechuga de pollo y verduras',merienda:'Tostadas con jamón cocido y plátano',cena:'Pasta con carne picada magra y tomate'},Martes:{desayuno:'Tostadas con huevos, plátano y leche',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Patata con ternera y ensalada',merienda:'Avena con leche y plátano',cena:'Arroz con salmón y verduras'},Miércoles:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con pavo',comida:'Pasta con pollo y verduras',merienda:'Tostadas con crema de cacahuete y plátano',cena:'Patata con merluza y ensalada'},Jueves:{desayuno:'Tostada con huevos, naranja y leche',media_mañana:'Yogur griego con avena y frutos secos',comida:'Pasta con pavo y verduras',merienda:'Tostadas con queso fresco batido y manzana',cena:'Arroz con ternera y verduras'},Viernes:{desayuno:'Avena con leche, plátano y huevos',media_mañana:'Bocadillo de pavo con fruta',comida:'Arroz con pollo y verduras',merienda:'Yogur con avena y frutos secos',cena:'Pasta con atún y tomate'},Sábado:{desayuno:'Tostadas con huevos, aguacate y fruta',media_mañana:'Yogur griego con avena y frutos secos',comida:'Patata con ternera y verduras',merienda:'Sándwich de pavo con plátano',cena:'Arroz con salmón y verduras'},Domingo:{desayuno:'Tortitas de avena con huevos y plátano',media_mañana:'Yogur con fruta y frutos secos',comida:'Arroz con carne y verduras',merienda:'Bocadillo de pavo con fruta',cena:'Patata con pescado y ensalada'}},
{Lunes:{desayuno:'Tostadas con huevos, plátano y crema de cacahuete',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Pasta con pechuga de pollo y verduras',merienda:'Bocadillo de pavo con fruta',cena:'Arroz con carne picada magra y verduras'},Martes:{desayuno:'Avena con leche, frutos rojos y huevos',media_mañana:'Tostada de pan integral con pavo',comida:'Patata con salmón y ensalada',merienda:'Tostadas con crema de cacahuete y plátano',cena:'Pasta con ternera y tomate'},Miércoles:{desayuno:'Tostadas con huevos, naranja y leche',media_mañana:'Yogur griego con avena y frutos secos',comida:'Arroz con merluza y verduras',merienda:'Avena con leche y plátano',cena:'Patata con pollo y ensalada'},Jueves:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con pavo',comida:'Pasta con pavo y verduras',merienda:'Tostadas con jamón cocido y fruta',cena:'Arroz con ternera y verduras'},Viernes:{desayuno:'Tostadas con huevos, aguacate y fruta',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Patata con pollo y verduras',merienda:'Bocadillo de pavo con plátano',cena:'Pasta con atún y verduras'},Sábado:{desayuno:'Avena con leche, plátano y huevos',media_mañana:'Tostada de pan integral con jamón',comida:'Arroz con ternera y ensalada',merienda:'Yogur con avena y frutos secos',cena:'Patata con salmón y verduras'},Domingo:{desayuno:'Tortitas de avena con huevos y fruta',media_mañana:'Yogur griego con avena y nueces',comida:'Pasta con carne y verduras',merienda:'Tostadas de pavo con fruta',cena:'Arroz con merluza y ensalada'}},
{Lunes:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con pavo',comida:'Arroz con pechuga de pollo y verduras',merienda:'Yogur griego con avena y frutos secos',cena:'Patata con merluza y ensalada'},Martes:{desayuno:'Tostadas con huevos, plátano y leche',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Pasta con ternera y verduras',merienda:'Tostadas con crema de cacahuete y plátano',cena:'Arroz con salmón y verduras'},Miércoles:{desayuno:'Tostadas con huevos, naranja y crema de cacahuete',media_mañana:'Bocadillo de pavo con fruta',comida:'Patata con pollo y ensalada',merienda:'Avena con leche y frutos secos',cena:'Pasta con carne picada magra y tomate'},Jueves:{desayuno:'Avena con leche, plátano y huevos',media_mañana:'Tostada de pan integral con pavo',comida:'Arroz con pavo y verduras',merienda:'Yogur griego con fruta y nueces',cena:'Patata con ternera y ensalada'},Viernes:{desayuno:'Tostadas con huevos, aguacate y fruta',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Pasta con pollo y verduras',merienda:'Tostadas de pavo con plátano',cena:'Arroz con atún y verduras'},Sábado:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con jamón',comida:'Patata con salmón y verduras',merienda:'Bocadillo de pavo con fruta',cena:'Pasta con ternera y ensalada'},Domingo:{desayuno:'Tortitas de avena con huevos y plátano',media_mañana:'Yogur con fruta y frutos secos',comida:'Arroz con carne y verduras',merienda:'Yogur griego con avena y frutos secos',cena:'Patata con pescado y ensalada'}},
{Lunes:{desayuno:'Tostadas con huevos, plátano y crema de cacahuete',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Pasta con pechuga de pollo y verduras',merienda:'Bocadillo de pavo con plátano',cena:'Arroz con carne picada magra y verduras'},Martes:{desayuno:'Avena con leche, frutos rojos y huevos',media_mañana:'Tostada de pan integral con pavo',comida:'Patata con ternera y ensalada',merienda:'Tostadas con crema de cacahuete y fruta',cena:'Arroz con salmón y verduras'},Miércoles:{desayuno:'Avena con leche, plátano y crema de cacahuete',media_mañana:'Tostada de pan integral con jamón',comida:'Pasta con pollo y verduras',merienda:'Yogur griego con avena y frutos secos',cena:'Patata con merluza y ensalada'},Jueves:{desayuno:'Tostadas con huevos, naranja y leche',media_mañana:'Bocadillo de pavo con fruta',comida:'Arroz con pavo y verduras',merienda:'Tostadas con queso fresco batido y manzana',cena:'Pasta con ternera y verduras'},Viernes:{desayuno:'Avena con leche, plátano y huevos',media_mañana:'Yogur griego con avena y frutos rojos',comida:'Patata con pollo y verduras',merienda:'Tostadas de pavo con plátano',cena:'Arroz con atún y verduras'},Sábado:{desayuno:'Tostadas con huevos, aguacate y fruta',media_mañana:'Tostada de pan integral con pavo',comida:'Pasta con salmón y verduras',merienda:'Yogur con avena y frutos secos',cena:'Patata con ternera y ensalada'},Domingo:{desayuno:'Tortitas de avena con huevos y fruta',media_mañana:'Yogur griego con avena y nueces',comida:'Arroz con carne y verduras',merienda:'Bocadillo de pavo con fruta',cena:'Patata con pescado y ensalada'}}
];
